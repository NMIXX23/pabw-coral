...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="akademik.php" class="dropdown-item active">Akademik</a>
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Akademik</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Beasiswa</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Akademik</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Akademik</h1>
    ...
    $sql = "SELECT * FROM `akademik` WHERE `status` = 'tersedia' ORDER BY `akademik`.`id` DESC";
...
<div id="tab-2" class="tab-pane fade show p-0 active">
    ...
    $sql = "SELECT * FROM `akademik` WHERE `status` = 'tersedia' ORDER BY `akademik`.`beasiswa` ASC";
    $result = $connection->query($sql);
