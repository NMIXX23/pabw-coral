...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown">Beasiswa</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="akademik.php" class="dropdown-item">Akademik</a>
                            <a href="nonakademik.php" class="dropdown-item active">Non Akademik</a>
                        </div>
                    </div>
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Non Akademik</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Beasiswa</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Non Akademik</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Non Akademik</h1>
    ...
    $sql = "SELECT * FROM `nonakademik` WHERE `status` = 'tersedia' ORDER BY `nonakademik`.`id` DESC";
                ...
                <div class="col">
                     <div class="collapse multi-collapse" id="collapse-' . $row["id"] . '">
                        <div class="card text-start">
                            <h4>Jenjang</h4><br>' . $row["jenjang"] . '<br><br>
...
<div id="tab-2" class="tab-pane fade show p-0 active">
    ...
    $sql = "SELECT * FROM `nonakademik` WHERE `status` = 'tersedia' ORDER BY `nonakademik`.`id` ASC ";
    $result = $connection->query($sql);
